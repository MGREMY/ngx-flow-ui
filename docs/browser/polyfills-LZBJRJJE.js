...
(function (e) {
  ...
  if (e.Zone) {
    if (y || typeof e.Zone.__symbol__ != 'function') throw new Error('Zone already loaded.');
    return e.Zone;
  }
  let oe = class oe {
    ...
    wrap(t, s) {
      if (typeof t != 'function') throw new Error('Expecting function got: ' + t);
      ...
      try {
        ...
        t.state !== H &&
          ...
          (t.type == K || (t.data && t.data.isPeriodic)
            ...
            : ((t.runCount = 0), this._updateTaskCount(t, -1), v && t._transitionTo(H, T, H))),
          (U = U.parent),
          (te = F);
      }
    }
    scheduleTask(t) {
      ...
      try {
        ...
        throw (t._transitionTo(d, X, H), this._zoneDelegate.handleError(this, o), o);
      }
      return t._zoneDelegates === s && this._updateTaskCount(t, 1), t.state == X && t._transitionTo(M, X), t;
    }
    ...
    cancelTask(t) {
      ...
      if (!(t.state !== M && t.state !== T)) {
        ...
        try {
          ...
          throw (t._transitionTo(d, x), this._zoneDelegate.handleError(this, s), s);
        }
        return this._updateTaskCount(t, -1), t._transitionTo(H, x), (t.runCount = 0), t;
      }
    }
  ...
  class k {
    constructor(t, s, o) {
      ...
      (v || F) &&
        ...
        o.onScheduleTask ||
          ((this._scheduleTaskZS = b), (this._scheduleTaskDlgt = s), (this._scheduleTaskCurrZone = this.zone)),
        o.onInvokeTask ||
          ((this._invokeTaskZS = b), (this._invokeTaskDlgt = s), (this._invokeTaskCurrZone = this.zone)),
        o.onCancelTask ||
          ((this._cancelTaskZS = b), (this._cancelTaskDlgt = s), (this._cancelTaskCurrZone = this.zone)));
    }
    fork(t, s) {
    ...
    intercept(t, s, o) {
      return this._interceptZS
        ? this._interceptZS.onIntercept(this._interceptDlgt, this._interceptCurrZone, t, s, o)
        : s;
    }
    invoke(t, s, o, v, F) {
      return this._invokeZS
        ? this._invokeZS.onInvoke(this._invokeDlgt, this._invokeCurrZone, t, s, o, v, F)
        : s.apply(o, v);
    }
    handleError(t, s) {
      return this._handleErrorZS
        ? this._handleErrorZS.onHandleError(this._handleErrorDlgt, this._handleErrorCurrZone, t, s)
        : !0;
    }
    scheduleTask(t, s) {
      let o = s;
    ...
    invokeTask(t, s, o, v) {
      return this._invokeTaskZS
        ? this._invokeTaskZS.onInvokeTask(this._invokeTaskDlgt, this._invokeTaskCurrZone, t, s, o, v)
        : s.callback.apply(o, v);
    }
    cancelTask(t, s) {
      let o;
      if (this._cancelTaskZS) o = this._cancelTaskZS.onCancelTask(this._cancelTaskDlgt, this._cancelTaskCurrZone, t, s);
      else {
    ...
    _updateTaskCount(t, s) {
      ...
      if (v == 0 || F == 0) {
        let u = { microTask: o.microTask > 0, macroTask: o.macroTask > 0, eventTask: o.eventTask > 0, change: t };
  ...
  class m {
    ...
    _transitionTo(t, s, o) {
      if (this._state === s || this._state === o) (this._state = t), t == H && (this._zoneDelegates = null);
      else
        throw new Error(
          `${this.type} '${this.source}': can not transition to '${t}', expecting state '${s}'${
            o ? " or '" + o + "'" : ''
          }, was '${this._state}'.`
        );
    }
...
var j = Zone.__symbol__,
  ...
  at = 'removeAttribute';
function He(e, n) {
  for (let c = e.length - 1; c >= 0; c--) typeof e[c] == 'function' && (e[c] = Ae(e[c], n + '_' + c));
  return e;
}
function lt(e, n) {
...
var $e = typeof WorkerGlobalScope < 'u' && self instanceof WorkerGlobalScope,
  ...
  We = function (e) {
    ...
    if (xe && c === Te && e.type === 'error') {
      let l = e;
      (a = r && r.call(this, l.message, l.filename, l.lineno, l.colno, l.error)), a === !0 && e.preventDefault();
    } else (a = r && r.apply(this, arguments)), a != null && !a && e.preventDefault();
    return a;
  };
function qe(e, n, c) {
  let r = me(e, n);
  if ((!r && c && me(c, n) && (r = { enumerable: !0, configurable: !0 }), !r || !r.configurable)) return;
  ...
  b || (b = be[_] = j('ON_PROPERTY' + _)),
    ...
    (r.get = function () {
      ...
      if (l) {
        let I = l.call(this);
        if (I) return r.set.call(this, I), typeof k[at] == 'function' && k.removeAttribute(n), I;
      }
      return null;
    }),
    Ne(e, n, r),
...
function Ke(e, n, c) {
  if (n) for (let r = 0; r < n.length; r++) qe(e, 'on' + n[r], c);
  else {
    let r = [];
    for (let a in e) a.slice(0, 2) == 'on' && r.push(a);
    for (let a = 0; a < r.length; a++) qe(e, r[a], c);
  }
}
    ...
    (e === 'XMLHttpRequest' && r === 'responseBlob') ||
      (function (a) {
        typeof c[a] == 'function'
          ...
          : Ne(Y[e].prototype, a, {
              set: function (l) {
                typeof l == 'function' ? ((this[ne][a] = Ae(l, e + '.' + a)), ae(this[ne][a], l)) : (this[ne][a] = l);
              },
              get: function () {
                return this[ne][a];
              },
...
function le(e, n, c) {
  let r = e;
  for (; r && !r.hasOwnProperty(n); ) r = Ie(r);
  !r && e[n] && (r = e);
  let a = j(n),
    l = null;
  ...
  function z(u, f, i) {
    ...
    if (u[q] === M) {
      ...
      if (f !== x && i instanceof t && i.hasOwnProperty(q) && i.hasOwnProperty(R) && i[q] !== M)
        ...
        u[q] = f;
        let w = u[R];
        if (((u[R] = i), u[E] === E && f === T && ((u[q] = u[H]), (u[R] = u[$])), f === x && i instanceof Error)) {
          let p = n.currentTask && n.currentTask.data && n.currentTask.data[I];
          p && a(i, re, { configurable: !0, enumerable: !1, writable: !0, value: p });
        }
        for (let p = 0; p < w.length; ) Q(u, w[p++], w[p++], w[p++], w[p++]);
        if (w.length == 0 && f == x) {
          u[q] = d;
          let p = i;
          try {
...
` + i.stack
  ...
  function te(u) {
    if (u[q] === d) {
      try {
        let f = n[U];
        f && typeof f == 'function' && f.call(this, { rejection: u[R], promise: u });
      } catch {}
      u[q] = x;
      for (let f = 0; f < _.length; f++) u === _[f].promise && _.splice(f, 1);
    }
  }
  ...
  class t {
    ...
    static any(f) {
      if (!f || typeof f[Symbol.iterator] != 'function') return Promise.reject(new L([], 'All promises were rejected'));
      let i = [],
        h = 0;
      try {
        for (let p of f) h++, i.push(t.resolve(p));
      } catch {
        return Promise.reject(new L([], 'All promises were rejected'));
      }
      if (h === 0) return Promise.reject(new L([], 'All promises were rejected'));
      let g = !1,
        w = [];
      return new t((p, C) => {
        for (let S = 0; S < i.length; S++)
          i[S].then(
            ...
            D => {
              w.push(D), h--, h === 0 && ((g = !0), C(new L(w, 'All promises were rejected')));
            }
          );
      });
    }
    static race(f) {
      ...
      for (let C of f) B(C) || (C = this.resolve(C)), C.then(w, p);
      return g;
    }
    static all(f) {
    ...
    then(f, i) {
      ...
      let g = new h(oe),
        w = n.current;
      return this[q] == M ? this[R].push(w, g, f, i) : Q(this, w, g, f, i), g;
    }
    catch(f) {
      ...
      h[E] = E;
      let g = n.current;
      return this[q] == M ? this[R].push(g, h, f, f) : Q(this, g, h, f, f), h;
    }
  }
  ...
  return s && (v(s), le(e, 'fetch', u => F(u))), (Promise[n.__symbol__('uncaughtPromiseErrors')] = _), t;
});
  ...
  let n = Function.prototype.toString,
    ...
    l = function () {
      if (typeof this == 'function') {
        let k = this[c];
        if (k) return typeof k == 'function' ? n.call(k) : Object.prototype.toString.call(k);
        if (this === Promise) {
          let m = e[r];
...
function _t(e, n, c, r) {
  let a = (r && r.add) || Me,
    ...
    Z = function (R, E, $) {
      ...
      let H = R.callback;
      typeof H == 'object' && H.handleEvent && ((R.callback = T => H.handleEvent(T)), (R.originalDelegate = H));
      let X;
      try {
        R.invoke(R, E, [$]);
      } catch (T) {
  ...
  function J(R, E) {
    ...
    let T = R;
    for (; T && !T.hasOwnProperty(a); ) T = Ie(T);
    ...
    let te = function (i) {
        if (!d.isExisting) return N.call(d.target, d.eventName, d.capture ? A : B, d.options);
      },
      Q = function (i) {
        if (!i.isRemoved) {
          let h = ee[i.eventName],
            g;
          ...
          if (w) {
            for (let p = 0; p < w.length; p++)
              if (w[p] === i) {
                w.splice(p, 1), (i.isRemoved = !0), w.length === 0 && ((i.allRemoved = !0), (i.target[g] = null));
                break;
              }
          }
        }
        if (i.allRemoved) return P.call(i.target, i.eventName, i.capture ? A : B, i.options);
      },
      W = function (i) {
      ...
      f = function (i, h, g, w, p = !1, C = !1) {
        return function () {
          ...
          if (we && D === 'uncaughtException') return i.apply(this, arguments);
          let V = !1;
          ...
          if (F) {
            for (let he = 0; he < F.length; he++)
              if (D === F[he]) return ue ? i.call(S, D, G, se) : i.apply(this, arguments);
          }
          ...
          for (let G = 0; G < D.length; G++) {
            ...
            if (v(V, p)) {
              if (
                (D.splice(G, 1),
                (V.isRemoved = !0),
                D.length === 0 && ((V.allRemoved = !0), (i[S] = null), typeof h == 'string'))
              ) {
        ...
        a.forEach(function (m) {
          ...
          try {
            if (Z.hasOwnProperty(m)) {
              ...
              O && O.value
                ? ((O.value = e.wrapWithCurrentZone(O.value, I)), e._redefineProperty(b.prototype, m, O))
                : Z[m] && (Z[m] = e.wrapWithCurrentZone(Z[m], I));
            } else Z[m] && (Z[m] = e.wrapWithCurrentZone(Z[m], I));
          } catch {}
        }),
      y.call(n, _, b, k)
    );
...
function yt(e, n) {
  if ((we && !Je) || Zone[e.symbol('patchEvents')]) return;
  ...
  if (xe) {
    ...
    let l = ft() ? [{ target: a, ignoreProperties: ['error'] }] : [];
...
Zone.__load_patch('util', (e, n, c) => {
  let r = Oe(e);
  (c.patchOnProperties = Ke), (c.patchMethod = le), (c.bindArguments = He), (c.patchMacroTask = ut);
        ...
        if (typeof I[0] == 'function') {
          ...
          I[0] = function () {
            try {
              ...
              Z.isPeriodic ||
                (typeof Z.handleId == 'number' ? delete y[Z.handleId] : Z.handleId && (Z.handleId[ve] = null));
            }
          };
          ...
          return (
            typeof A == 'number' ? (y[A] = B) : A && (A[ve] = B),
            A &&
              A.ref &&
              A.unref &&
              typeof A.ref == 'function' &&
              typeof A.unref == 'function' &&
              ((B.ref = A.ref.bind(A)), (B.unref = A.unref.bind(A))),
    ...
    (l = le(
      ...
      k =>
        function (m, I) {
          let Z = I[0],
            O;
          typeof Z == 'number' ? (O = y[Z]) : ((O = Z && Z[ve]), O || (O = Z)),
            O && typeof O.type == 'string'
              ? O.state !== 'notScheduled' &&
                ((O.cancelFn && O.data.isPeriodic) || O.runCount === 0) &&
                (typeof Z == 'number' ? delete y[Z] : Z && (Z[ve] = null), O.zone.cancelTask(O))
              : k.apply(e, I);
        }
    ));
}
...
function gt(e, n) {
  ...
  let _ = e.EventTarget;
  if (!(!_ || !_.prototype)) return n.patchEventTarget(e, n, [_ && _.prototype]), !0;
}
function kt(e, n) {
...
Zone.__load_patch('XHR', (e, n) => {
  ...
  function b(k) {
    ...
    function q(d) {
      ...
      (P[l] = !1), (P[_] = !1);
      let K = P[a];
      O || ((O = P[Se]), (B = P[De])), K && B.call(P, A, K);
      let re = (P[a] = () => {
          ...
          if (!N.aborted && P[l] && d.state === J) {
            ...
            if (P.status !== 0 && U && U.length > 0) {
              ...
              (d.invoke = function () {
                ...
                for (let W = 0; W < Q.length; W++) Q[W] === d && Q.splice(W, 1);
      ...
      return O.call(P, A, re), P[c] || (P[c] = d), T.apply(P, N.args), (P[l] = !0), d;
    }
    function R() {}
    function E(d) {
      let N = d.data;
      ...
      T = le(
        ...
        () =>
          function (d, N) {
            ...
            {
              let P = { target: d, url: d[y], isPeriodic: !1, args: N, aborted: !1 },
                K = je(H, R, P, q, E);
...
Zone.__load_patch('PromiseRejectionEvent', (e, n) => {
  ...
  e.PromiseRejectionEvent &&
    ((n[j('unhandledPromiseRejectionHandler')] = c('unhandledrejection')),
